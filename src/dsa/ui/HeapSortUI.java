...
import dsa.algorithms.HeapSort;
...
public class HeapSortUI extends JFrame {
    ...
    private void initComponents() {
        ...
        inputArrayField = new JTextField("4, 10, 3, 5, 1");
        ...
        JButton runButton = new JButton("Run Heap Sort");
        runButton.addActionListener(e -> performHeapSort());
    ...
    private void performHeapSort() {
        try {
            ...
            int[] sortedArray = HeapSort.sort(array.clone());
            long endTime = System.nanoTime();

            StringBuilder output = new StringBuilder();
            output.append("Heap Sort Result:\n");
            ...
            output.append("Complexity: ").append(ComplexityUtil.heapSort()).append("\n");
            output.append("\nPseudocode:\n").append(ComplexityUtil.heapSortPseudocode());
